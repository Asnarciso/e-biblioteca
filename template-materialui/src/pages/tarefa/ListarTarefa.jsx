...
const initialRows = [
  createData(1, 'Amanda Narciso', 'Violetas na Janela', '2024-06-01', '2024-06-16', 'Devolvido'),
  createData(2, 'Ivan Farina', 'A guerra dos tronos', '2024-06-01', '2024-06-16', 'Emprestado'),
  createData(3, 'Marina Farina', 'O mundo de Sofia', '2024-06-02', '2024-06-17', 'Emprestado'),
];
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableRow>
                    <TableCell>#</TableCell>
                    <TableCell>Nome do leitor</TableCell>
                    <TableCell align="right">Nome do Livro</TableCell>
                    <TableCell align="right">Data do empréstimo</TableCell>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen}  sx={{ backgroundColor: 'black' }}>Cadastrar Empréstimo</Button>
